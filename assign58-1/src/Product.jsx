...
function Product(props){
    return(
        <div className="w-72 m-5 gap-1 flex flex-col pb-5 grow">
            ...
            <Link to="/ProductCard" className="bg-blue-500 rounded-xl py-3 px-6 mx-3 grow text-center hover:ring-2 hover:ring-blue-500 hover:ring-offset-2 hover:text-white">View details</Link>
        </div>
    )
